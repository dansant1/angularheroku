...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'pedido/chat', loadChildren: () => import('./Pedidos/Chat/pedido-chat.module').then(mod => mod.PedidoChatModule), data: {extraParameter: 'dashboardsMenu', animation: 'PedidoChatModule'} },
