...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'cliente/seleccion-categoria', loadChildren: () => import('./Cliente/Pedido/Seleccion_Categoria/seleccion-categoria.module').then(mod => mod.SeleccionCategoriaModule), data: {extraParameter: 'dashboardsMenu'}, canActivate: [AuthGuard] },
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'cliente/seleccion-restaurante', loadChildren: () => import('./Cliente/Pedido/Seleccion_Restaurante/seleccion-restaurante.module').then(mod => mod.SeleccionRestauranteModule), data: {extraParameter: 'dashboardsMenu'}, canActivate: [AuthGuard] },

      { path: 'cliente/perfil-restaurante', loadChildren: () => import('./Cliente/Pedido/Perfil_Restaurante/perfil-restaurante.module').then(mod => mod.PerfilRestauranteModule), data: {extraParameter: 'dashboardsMenu'}, canActivate: [AuthGuard] },
      ...
      { path: 'administracion/referidos', loadChildren: () => import('./Administracion/Referidos/referidos.module').then(mod => mod.ReferidosModule), data: {extraParameter: 'dashboardsMenu'} },
      ...
      { path: 'administracion-negocio/mediosdepago', loadChildren: () => import('./Negocio/MediosPago/mediosdepago.module').then(mod => mod.MediosPagoModule), data: {extraParameter: 'dashboardsMenu'}, canActivate: [AuthGuard] },
