...
export class UbicacionesComponent implements OnInit {
  ...
  cambiarDireccion(direccion_t){
    ...
    .subscribe
      (
          (data : any) =>   {
            this.dataService.ejecutarModal({ "titulo" : "¡Listo!" , "mensaje" : "Su ubicación ha sido guardada." , "mostrar_imagen" : true, "url_imagen" : "https://codigeek.com/projects/robertodelivery/ilustracion_home.png", "tipo" : 1 });
            this.authenticationService.changeUserInfo(this.currentUser$);
            console.log(this.regresarUrl$);
            if( this.regresarUrl$ ){
              this.router.navigateByUrl( this.regresarUrl$ , { state : { get_pedido_guardado : true } });
