...
export class PerfilNegocioComponent implements OnInit {
      ...
      .subscribe
        (
            (data : any) =>   {
              this.modalReference.close();
              this.dataService.generalAlert(data);
              this.currentUser$.negocio.foto = data.foto;
              this.authenticationService.setUser(this.currentUser$);
            },
            error =>  {
              this.dataService.generalAlert(error);
  ...
  getNegocio(negocio_t){
    this.dataService.useService( "get_negocio_by_id" , { data : negocio_t } )
    .subscribe
      (
          (data : any) =>   {
  ...
  ngOnInit() {
    ...
    this.getNegocio( this.currentUser$.negocio );
